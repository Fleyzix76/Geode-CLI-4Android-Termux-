...
#[allow(dead_code)]
pub static TARGET: &str = "aarch64-linux-android";
#[doc=r#"The host triple of the rust compiler."#]
#[allow(dead_code)]
pub static HOST: &str = "aarch64-linux-android";
...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.96.0 (ac68faa20 2026-05-25) (built from a source tarball)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.96.0 (ac68faa20 2026-05-25) (built from a source tarball)";
